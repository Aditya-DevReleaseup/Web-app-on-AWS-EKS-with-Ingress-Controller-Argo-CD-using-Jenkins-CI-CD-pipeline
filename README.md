...
git remote set-url origin https://<your\_username>:<your\_token>@github.com/Aditya-DevReleaseup/Web-app-on-AWS-EKS-with-Ingress-Controller-Argo-CD-using-Jenkins-CI-CD-pipeline.git
